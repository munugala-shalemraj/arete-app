...
class _SusSurveyScreenState extends State<SusSurveyScreen> {
  ...
  double _calculateSusScore() {
    ...
    // Sum × 2.5 → 0-100 scale
    return calculateSusScore(_responses.map((value) => value ?? 3).toList());
  }
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          'Any comments about your experience with Arete...',
